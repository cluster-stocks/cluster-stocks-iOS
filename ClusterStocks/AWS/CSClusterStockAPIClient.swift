...
public class CSClusterStockAPIClient: AWSAPIGatewayClient {
    ...
    /*
     ...
     return type: CSStockGetResponseMethodModel
     */
    public func stockGet(ticker: String) -> AWSTask<CSStockGetResponseMethodModel> {
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/stock", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: CSStockGetResponseMethodModel.self) as! AWSTask<CSStockGetResponseMethodModel>
	}
    ...
    /*
     ...
     return type: CSStockPostResponseMethodModel
     */
    public func stockPost(body: CSStockPostRequestMethodModel) -> AWSTask<CSStockPostResponseMethodModel> {
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/stock", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: body, responseClass: CSStockPostResponseMethodModel.self) as! AWSTask<CSStockPostResponseMethodModel>
	}
    ...
    /*
     ...
     return type: CSUserGetResponseMethodModel
     */
    public func userGet(userName: String) -> AWSTask<CSUserGetResponseMethodModel> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/user", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: CSUserGetResponseMethodModel.self) as! AWSTask<CSUserGetResponseMethodModel>
	}
    ...
    /*
     ...
     return type: CSUserPutResponseMethodModel
     */
    public func userPut(body: CSUserPutRequestMethodModel) -> AWSTask<CSUserPutResponseMethodModel> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("PUT", urlString: "/user", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: body, responseClass: CSUserPutResponseMethodModel.self) as! AWSTask<CSUserPutResponseMethodModel>
	}
    ...
    /*
     ...
     return type: CSUserPostResponseMethodModel
     */
    public func userPost(body: CSUserPostRequestMethodModel) -> AWSTask<CSUserPostResponseMethodModel> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/user", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: body, responseClass: CSUserPostResponseMethodModel.self) as! AWSTask<CSUserPostResponseMethodModel>
	}
